...
Property-preserving encryption techniques create ciphertexts having weaker
security but better functionality so that a certain operation can be seemlessly
performed within an unprotected database.
%
Examples include deterministic encryption which can answer equality queries and
order-preserving encryption which can answer range queries. Academic teams,
