...
\subsection{Creating a modular POPE}
...
Leakage attacks are particularly problematic when the adversary is able to correlated leakage from multiple queries.  Forward security searchable encryption can decouple the adversary's leakage and force them to execute their attack with less information.  
