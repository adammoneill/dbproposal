...
partitioning, we can greatly reduce the leakage stemming from this procedure.
We plan to theoretically explore and practically measure the tradeoff of our
approach in terms of performance vs security. 
